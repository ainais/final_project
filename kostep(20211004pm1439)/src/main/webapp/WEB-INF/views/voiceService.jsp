		...
		<div class="row">
			<div class="col-md-4">
				<div
					...
					<div>
						<form action="audioUpload.do" method="post" enctype="multipart/form-data" id="audioUploadForm">
					
					<input type="file" id="audio_uploads" name="file"
								accept=".wav" multiple />
						</form>
					</div>
					<br>
			...
			<div class="col-md-8">
			<br><br><br><br><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-success btn-lg" id="audioUploadButton">오디오 텍스트로 변환하기</button>
			</div>
		</div>
	</div>
</section>
