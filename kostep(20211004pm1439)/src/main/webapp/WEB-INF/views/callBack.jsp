		...
		window.addEventListener('load', function () {
			naverLogin.getLoginStatus(function (status) {
				if (status) {
					...
					//alert(birthday);
					alert(Object.getOwnPropertyNames(naverLogin));
					

					//var mobile = naverLogin.user.getMobile();
					//alert(mobile);
					//var birthyear = naverLogin.user.getBirhthyear();
					//alert(birthyear);
					...
					*/
					window.location.replace("http://" + window.location.hostname + 
                            ( (location.port==""||location.port==undefined)?"":":" + location.port) + "/kostep/index.jsp");
