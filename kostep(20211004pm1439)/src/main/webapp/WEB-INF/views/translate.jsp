    ...
    <section class="hero-wrap hero-wrap-2 d-flex" style="background-image: url(images/bg_2.jpg);">
    	...
    	<div class="container">
    		<div class="row d-flex align-items-center">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="translate">홈</a></span> <span>번역하기</span></p>
	            <a href="textService" class="nav-link">글 번역</a>
	            <a href="imgService" class="nav-link">이미지 번역</a>
